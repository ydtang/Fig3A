...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 myAMPA D:/Dendritic action potentials and computation in/GidonEtAl2020_fig3andS9/NEURON_Code/_mod/myAMPA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "myAMPA.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
  "\n"
