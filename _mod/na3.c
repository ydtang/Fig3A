...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "na_ion");
 	...
 	ivoc_help("help ?1 na3 D:/Dendritic action potentials and computation in/GidonEtAl2020_fig3andS9/NEURON_Code/_mod/na3.mod\n");
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 81 in file na3.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
