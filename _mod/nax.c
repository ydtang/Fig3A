...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "na_ion");
 	...
 	ivoc_help("help ?1 nax D:/Dendritic action potentials and computation in/GidonEtAl2020_fig3andS9/NEURON_Code/_mod/nax.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("nax", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 70 in file nax.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
